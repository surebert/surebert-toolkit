 ...
 * @name sb.md5
 * @author Paul Visco
 * @description used to calc md5 of string
 * Modified for use with surebert.com javascript toolkit by Paul Visco
 ...
 * @name sb.strings.md5
 * @author Paul Visco
 * @description converts any string to md5
 * @param {String} str The orig string
 * @returns {string} md5 hash of string
 * @function
 * @example 
 * sb.strings.md5('hello world');
 * //newString = '&lt;p&gt;hello&lt;/p&gt;'
 */
sb.strings.md5 = function(str) {
    return sb.md5.hex(str);
};